...
/* Includes ------------------------------------------------------------------*/
#include "main.h"
extern  uint8_t aaUsbBufferOut[64];
...
//  /* Start Channel1 */
////  if(HAL_TIM_Base_Start_IT(&TimHandleX) != HAL_OK)
////  {
////    /* Starting Error */
////    Error_Handler();
////  }
...
/**
  ...
  * @retval None
  */
uint8_t vituarlComTransmit(int8_t*pData, uint32_t size){
	
	USBD_CDC_SetTxBuffer(&hUSBDDevice, pData, size); 
...
void CDC_GetNewPack(void){
	/* Prepare Out endpoint to receive next packet */
   USBD_LL_PrepareReceive(&hUSBDDevice,0x01,aaUsbBufferOut,64);
}
/**
...
//  */
//  TimHandleX.Init.Period = (CDC_POLLING_INTERVAL*1000) - 1;
//  TimHandleX.Init.Prescaler = 84-1;
//  TimHandleX.Init.ClockDivision = 0;
//  TimHandleX.Init.CounterMode = TIM_COUNTERMODE_UP;
//  if(HAL_TIM_Base_Init(&TimHandleX) != HAL_OK)
//  {
//    /* Initialization Error */
//    Error_Handler();
//  }
